...
import { PilotListing } from "@/src/components/Pilots/Pilots";
import { getRestaurants, getUserById } from "@/src/lib/firebase/firestore.js";
...
export default async function Home(props) {
  ...
  return (
    <main className="main__home">
      <Suspense
        fallback={<h1>You have no pilots!</h1>}
      >
        <PilotListing
          initialPilots={{}}
